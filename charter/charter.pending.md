...
_This charter represents a new - and slightly differet approach to managing the members interests in Josra, compared to the [original charter](/charter/). The improvements are made based on the way we de facto work with managing Josra issues_{: .subtitle}
...
Each Josra member organization will be entitled and encouraged to appoint two persons to represent their membership in the alliance.
...
Members will be [listed here](/members/) as they sign up.

Each member will have it's own subpage on the Josra web, where the representatives from each member organization will be listed.
...
For each signup or renewal of an annual alliance membership, there will be added 40 hours of work to the common Josra pot, all these work hours will be spent on   work performed on developing and maintaining tools and technologies in the Josra tool stack.
